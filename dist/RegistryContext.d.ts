...
import { ComponentManifest, CategoryType, ImageURLShape } from "../";
...
export declare function normalizeBlock({
  ...
  editableProps: import("../dist/EditableProps").EditablePropMap;
  defaultProps: {
    data: {};
  };
  id: string;
};
export declare function normalizeInline({
  title,
  description,
  screenshot,
  placeholder,
...
export declare class RegistryProvider extends React.PureComponent<
  Props,
  State
> {
