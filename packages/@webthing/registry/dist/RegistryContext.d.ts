...
export declare function normalizeBlock({ title, description, screenshot, category, placeholder, author, src, isRemote, isVoid, multiLine, Component, isDevelopment, isGrouped, EditorComponent: _EditorComponent, editableProps, defaultProps, id }: ComponentManifest): {
    title: string;
    description: string;
